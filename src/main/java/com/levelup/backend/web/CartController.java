...
public class CartController {
  ...
  public CartResponse addItem(@PathVariable Long userId, @RequestBody AddItemRequest req) {
  ...
  public CartResponse remove(@PathVariable Long userId, @PathVariable Long itemId) {
